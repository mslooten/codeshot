const modes = [
  ...
  },
  {
    ...
    options: [
      ...
      { value: "Closure Stylesheets (GSS)", label: "Closure Stylesheets (GSS)" },
      ...
      { value: "Elm", label: "Elm" },
      { value: "Embedded Javascript", label: "Embedded Javascript" },
      { value: "Embedded Ruby", label: "Embedded Ruby" },
      ...
      { value: "GitHub Flavored Markdown", label: "GitHub Flavored Markdown" },
      { value: "Go", label: "Go" },
      ...
      { value: "MariaDB SQL", label: "MariaDB SQL" },
      ...
      { value: "Properties files", label: "Properties files" },
      { value: "ProtoBuf", label: "ProtoBuf" },
      { value: "Puppet", label: "Puppet" },
      { value: "Q", label: "Q" },
      { value: "R", label: "R" },
      { value: "reStructuredText", label: "reStructuredText" },
      { value: "RPM Changes", label: "RPM Changes" },
      ...
      { value: "Tiki wiki", label: "Tiki wiki" },
      { value: "TOML", label: "TOML" },
      { value: "Tornado", label: "Tornado" },
      { value: "troff", label: "troff" },
      { value: "TTCN", label: "TTCN" },
      { value: "TTCN_CFG", label: "TTCN_CFG" },
      { value: "Turtle", label: "Turtle" },
      { value: "TypeScript", label: "TypeScript" },
      { value: "TypeScript-JSX", label: "TypeScript-JSX" },
      ...
      { value: "Vue.js Component", label: "Vue.js Component" },
      { value: "XML", label: "XML" },
